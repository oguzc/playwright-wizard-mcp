...
export const analyzeAppTool: MCPTool = {
  ...
  description:
    "Step 1: Comprehensive application analysis, using both local files and live DOM/context via Playwright MCP and context7.",
  inputSchema: {
...
3. **Evaluate DOM Quality**n+   - Use Playwright MCP to enumerate ARIA, roles, test-ids, and all key HTML/DOM markers.
